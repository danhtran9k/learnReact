    ...
    <div className="card w-full">
      <div className="card-body bg-gray-200 py-8 rounded-tl-lg rounded-tr-lg ">
        ...
        <p className="text-black text-1xl font-thin my-2">
          ...
          qui maxime quos temporibus nulla eveniet reiciendis! Dolore,
          architecto dicta suscipit illo debitis numquam expedita deserunt
          reiciendis, adipisci, ullam ea!
        </p>
      </div>

      <div className="card-footer bg-gray-100 justify-between flex px-2">
        <p className="my-3">1 USD</p>
        <button className="rounded-lg bg-purple-500 text-white px-2 my-2 py-2 transition hover:text-purple-500 hover:bg-gray-300  duration-500">
          Register
        </button>
      </div>
    </div>
