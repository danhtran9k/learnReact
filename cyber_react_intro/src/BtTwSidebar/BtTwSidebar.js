 ...
 * https://mambaui.com/
 *
 * 1 số trang sẽ có phí
 * demo kỹ thuật thoi nhưng đang bị 1 số class của bootstrap đè
 */

export default function BtTwSidebar() {
    ...
    <div>
      ...
      <div className="grid grid-cols-6">
        ...
        <div className="col-span-5">
          <h3 className="text-center text-purple-500 text-8xl mt-3">Menu</h3>
          <h4 className="text-center text-red-500">
            Demo class của tailwind nhưng đang bị 1 số class của BS đè
          </h4>
          <SidebarCard
            itemSidebar={_.filter(data, (item) => item.maDanhMuc === maDanhMuc)}
